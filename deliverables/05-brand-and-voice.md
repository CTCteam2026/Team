# CTC Brand & Voice Reference
*Source of truth extracted from the **2026 Master Proposal Template** (more current than the live website). All web copy, mockups, schema, and AI-answer content should conform to this. Where the website and this doc disagree, **this wins.***
...
- Certified woman-owned · Incorporated in California · Insured, Licensed & Bonded.
- **NAICS:** 561920 (Event & Meeting Planning), 561599 (Travel & Reservation), 541661 (Consulting), 721199 (Other Travel Accommodations).
- CA Seller of Travel **2068923-50** · Cal eProcure **54839** · D&B **962631651** · CAGE Code **5SN86**.

## 6. Proven process (name it on the site — distinctive, ownable, AI-citable)
1. **Onboarding** *(upon signing)* — Welcome Guide, goals, communication protocols, kickoff.
2. **Project Management** — every detail tracked in ClickUp & Google Drive; the **Master Event Showbook** as the centralized guide.
3. **Onsite Experience** — a fully branded **Onsite Event Guide**; team manages everything in real time.
4. **Post-Event Report** — analytics, feedback, recommendations (can save up to 25% in labor next time).
...
## 8. Markets & industries served
**Markets:** Corporate · Associations · Government · Nonprofit · large-scale receptions · Sporting events / community events.
**Industries:** Aeroderivative Power Generation · Aviation & Maritime · Business Development · Commercial Real Estate · Community Development · Dental · Distribution · Education · Emergency · Engineers · Energy & Environment · Film · Government · Law Enforcement · Medical · Non-Profit · Public · Real Estate · Religious · Sports & Rec · Water.

## 9. Example clients (use only those cleared for public reference)
Carnegie Endowment (International Nuclear Policy Conference, Washington DC), MONage. *Confirm permissions before publishing any client name.*
